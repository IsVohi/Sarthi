        ...
        >
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Link href="/signup" className="bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] hover:opacity-90 text-white px-6 py-2.5 rounded-full text-sm font-semibold transition-all shadow-[0_0_15px_rgba(99,102,241,0.5)]">
                        Get Started
                    </Link>
                </div>
            </div>
